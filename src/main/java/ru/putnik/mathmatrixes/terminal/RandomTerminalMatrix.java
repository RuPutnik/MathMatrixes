...
public class RandomTerminalMatrix extends DefaultTerminalMatrix {
    public RandomTerminalMatrix(int countRow,int countColumn, double lowBorder, double topBorder,boolean integer){
